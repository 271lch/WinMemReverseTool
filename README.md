...
请使用项目根目录下的 main.cpp，不要用 ReverseTool.1 文件夹内的旧版本
...
Please use the main.cpp in the project root directory and do not use the old version in the ReverseTool.1 folder
